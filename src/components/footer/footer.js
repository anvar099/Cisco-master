    ...
    <div className="infos">
      <div className="footer-row">
        <div className="half">
          ...
          <h3 className="footer-p"><Text tid="footer-p1" /></h3>
        </div>
        <div className="half">
      ...
      <div className="footer-row">
        <div className="half">
          ...
          <h3 className="footer-p"><a href="tel:+998 (71) 276 47 46">+99412 310 38 33</a></h3>
        </div>
        <div className="half">
          <h4 className="footer-subtitle"><Text tid="footer-subtitle-service" /></h4>
          <h3 className="footer-p"><a href="tel:+998 (71) 276 33 33">+99412 310 38 33</a></h3>
        </div>
      </div>
    </div>
  </footer>
